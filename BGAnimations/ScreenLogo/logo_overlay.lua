...
t[#t+1] = LoadActor( THEME:GetPathG("","LOGO/nlogo3/logo_base_clear.png") )..{
	InitCommand=cmd(diffusealpha,0;y,SCREEN_CENTER_Y-20;x,SCREEN_CENTER_X;sleep,0;diffusealpha,1;zoom,0.55;);
}
...
t[#t+1] = LoadActor( THEME:GetPathG("","LOGO/nlogo3/nbaseglow_2.png") )..{
	InitCommand=cmd(diffusealpha,0;draworder,19;zoom,0.54;y,SCREEN_CENTER_Y-20;x,SCREEN_CENTER_X;sleep,0.5;diffusealpha,0.2;queuecommand,"Animate");
